...
function paintProvincias() {
	paintProvincia('Araba/Álava', '#F5F5DC');
	paintProvincia('Albacete', '#EEDC82');
	paintProvincia('Alacant/Alicante', '#FCF55F');
	paintProvincia('Almería', '#FFC000');
	paintProvincia('Ávila', '#FFC000');
	paintProvincia('Badajoz', '#FCF55F');
	paintProvincia('Illes Balears', '#F3E5AB');
	paintProvincia('Barcelona', '#F5F5DC');
	paintProvincia('Burgos', '#FFC000');
	paintProvincia('Cáceres', '#F5F5DC');
	paintProvincia('Cádiz', '#FCF55F');
	paintProvincia('Castelló/Castellón', '#FCF55F');
	paintProvincia('Ciudad Real', '#FFC000');
	paintProvincia('Córdoba', '#EEDC82');
	paintProvincia('A Coruña', '#FCF55F');
	paintProvincia('Cuenca', '#F5F5DC');
	paintProvincia('Girona', '#FCF55F');
	paintProvincia('Granada', '#FCF55F');
	paintProvincia('Guadalajara', '#FFC000');
	paintProvincia('Gipuzkoa', '#FCF55F');
	paintProvincia('Huelva', '#F5F5DC');
	paintProvincia('Huesca', '#FCF55F');
	paintProvincia('Jaén', '#F5F5DC');
	paintProvincia('León', '#FFC000');
	paintProvincia('Lleida', '#EEDC82');
	paintProvincia('La Rioja', '#EEDC82');
	paintProvincia('Lugo', '#F5F5DC');
	paintProvincia('Madrid', '#FCF55F');
	paintProvincia('Málaga', '#F5F5DC');
	paintProvincia('Murcia', '#F5F5DC');
	paintProvincia('Navarra', '#FFC000');
	paintProvincia('Ourense', '#EEDC82');
	paintProvincia('Asturias', '#EEDC82');
	paintProvincia('Palencia', '#F5F5DC');
	paintProvincia('Las Palmas', '#EEDC82');
	paintProvincia('Pontevedra', '#FFC000');
	paintProvincia('Salamanca', '#EEDC82');
	paintProvincia('Santa Cruz de Tenerife', '#FFC000');
	paintProvincia('Cantabria', '#FCF55F');
	paintProvincia('Segovia', '#EEDC82');
	paintProvincia('Sevilla', '#FFC000');
	paintProvincia('Soria', '#FCF55F');
	paintProvincia('Tarragona', '#FFC000');
	paintProvincia('Teruel', '#EEDC82');
	paintProvincia('Toledo', '#EEDC82');
	paintProvincia('València/Valencia', '#FFC000');
	paintProvincia('Valladolid', '#FCF55F');
	paintProvincia('Bizkaia', '#EEDC82');
	paintProvincia('Zamora', '#F5F5DC');
	paintProvincia('Zaragoza', '#F5F5DC');
	paintProvincia('Ceuta', '#EEDC82');
	paintProvincia('Melilla', '#FFC000');
